...
python3.2 tfg/bin/script.py 5 featuresDevALL dicctionary diccOfClasses fcDev5-N
python3.2 tfg/bin/script.py 10 featuresDevALL dicctionary diccOfClasses fcDev10-N
python3.2 tfg/bin/script.py 50 featuresDevALL dicctionary diccOfClasses fcDev50-N

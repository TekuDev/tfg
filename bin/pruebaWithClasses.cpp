...
int main(int nArgs, char* args[]) {
    if(nArgs != 5) {cout << "Debes introducir el nombre de los 2 ficheros de output [Features], [Dicctionary] y los features generados [ALL, OL(only lexical), OS (Only Syntactical)]" << endl; exit(0);}
    
    string featuresName, dicctionaryName, dcn, featTypes;
    featuresName = args[1]; dicctionaryName = args[2]; dcn = args[3]; featTypes = args[4];
    ...
    out[2].open("../inputs/diccOfClasses/"+dcn+".txt");

...
tfg/libsvm-3.21/svm-train -c $2 -t $1 -d 2 tfg/inputs/featuresCoded/fcTrain$3-$4.txt tfg/outputs/models/train$3-$4-$1-$2.model
...
cut -d' ' -f1 tfg/inputs/featuresCoded/fcDev$3.txt | paste - tfg/outputs/predictions/$3-$4-$1-$2_predict.txt > tfg/outputs/comparativas/c_$3-$4-$1-$2.txt

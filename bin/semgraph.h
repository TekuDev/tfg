...
namespace freeling {
  ...
  namespace semgraph {
    ...
    public:
      ...
      void set_w1(const const std::wstring &id1);
      void set_w2(const const std::wstring &id2);
      void set_t1(const const std::wstring &t1);
      void set_t2(const const std::wstring &t2);
      void set_rel(const const std::wstring &rel);
    };
    ...
    public:
      ...
      const vector<SG_relation_tmp> & get_relations() const;
      std::vector<SG_relation_tmp> & get_relations();
      //Return the temporal relations from wid to others
      const vector<SG_relation_tmp> & get_relations(const std::wstring &wid) const;
